...
<form id="form1" name="form1" method="post" action="">
  ...
  <table  border="1" cellpadding="10" align="center">
    ...
    <?php
	$sel= "SELECT tbl_studentreg.* FROM tbl_studentreg LEFT JOIN tbl_payment ON tbl_studentreg.stureg_id = tbl_payment.stureg_id WHERE tbl_payment.stureg_id IS NULL";
