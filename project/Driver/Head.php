...
<body class="g-sidenav-show  bg-gray-100">
  ...
  overflow: hidden;"></span>
    ...
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  active" href="HomepageDriver.php">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="Details.php">
            ...
            <span class="nav-link-text ms-1"><h6 style="color:white">Student in Route Details</h6></span>
          </a>
        </li>
        <li class="nav-item">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item ps-2 d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body p-0">
                ...
                <?php $sql = "SELECT * FROM tbl_driver WHERE driver_id =" . $_SESSION['did'];
                $res = $conn->query($sql);
                $row = $res->fetch_assoc(); ?>
                <img src="../ASSETS/File/User/<?php echo $row['driver_pic'] ?>" width="100" class="avatar avatar-sm"
                  alt="avatar" />
              </a>
            </li>
          </ul>
        ...
        <div class="col-md-12">
          <div class="d-md-flex align-items-center mb-3 mx-2">
            <div class="mb-md-0 mb-3">
              <h3 class="font-weight-bold mb-0">Hello,<?php echo $_SESSION['dname'] ?></h3>
              <p class="mb-0">Welcome to driver dashboard</p>
            </div>
